    ...
    <button type="button" onClick={onClick}
      ...
      <div style={{ minWidth:0 }}>
        <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", gap:6, minWidth:0 }}>
          <span style={{ fontWeight:700, fontSize:"0.8rem", letterSpacing:1, color:C.text,
    ...
    <div onClick={onClose} role="presentation"
      ...
      <div role="dialog" aria-modal="true" aria-label={`Chi tiết vũ khí ${data.name}`}
        ...
        <div style={{ textAlign:"center", marginBottom:16 }}>
          <div style={{ display:"inline-flex", padding:6, borderRadius:10,
          ...
          <div style={{ marginTop:12, fontSize:"1.1rem", fontWeight:900,
            letterSpacing:2, color:C.gold, textTransform:"uppercase" }}>{data.name}</div>
        ...
        <div style={{ height:1, margin:"12px 0 14px",
